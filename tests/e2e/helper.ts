import { Cedra, CedraSettings, CedraConfig, Network, NetworkToNetworkName } from "../../src";
 ...
 */
export function getCedraClient(additionalConfig?: CedraSettings): { cedra: Cedra; config: CedraConfig } {
